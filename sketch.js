...
function setup() {
  ...
  leftWall = new Base(100, height - 200, 200, height/2  + 100, "#8d6e63", true);
  rightWall = new Base(width - 100, height - 200, 200, height/2 + 100, "#8d6e63", true);
  ...
  jointPoint = new Base(width + 120 , height / 2 - 100, 400, 20, "#8d6e63", true);
